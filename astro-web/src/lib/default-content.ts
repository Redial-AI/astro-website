...
export const defaultLandingPageData: LandingPageData = {
    ...
    metaDescription:
        "Scale customer support, sales, and back-office operations with multilingual nearshore and offshore BPO teams.",
    blocks: [
        {
    ...
    footerNote:
        "This page is fully CMS-driven through Strapi. Edit copy, sections, and media without touching code.",
    settings: {
        siteName: "Redial BPO",
        logo: null,
        navLinks: [
        ...
        primaryActionHref: "https://redialbpo.com/book-a-consultation",
        contactPhone: "+1 (888) 440-3325",
        contactEmail: "sales@redialbpo.com",
        linkedInUrl: "https://www.linkedin.com/company/redialbpo/",
        footerCopy: "Redial BPO. All rights reserved.",
    },
};
